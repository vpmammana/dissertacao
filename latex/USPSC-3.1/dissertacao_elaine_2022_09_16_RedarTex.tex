...
As planilhas eletr\^onicas s\~ao softwares que permitem guardar e dados, realizar opera\c{c}\~oes com eles num formato de tabela, com o objetivo de deles extrair informa\c{c}\~oes.
...
A planilha eletr\^onica \'e um dos m\'etodos mais populares para armazenagem e an\'alise de dados porque tem uma curva de aprendizado relativamente favor\'avel. Em outras palavras, com pouca capacita\c{c}\~ao, o interessado consegue obter resultados rapidamente.
...
Com base nesta observa\c{c}\~ao de dificuldades, o foco aqui ser\'a embasar, por compara\c{c}\~ao, a decis\~ao de empregar a modelagem relacional, em detrimento de outros m\'etodos menos estruturados, como \'e o caso das planilhas eletr\^onicas. A modelagem relacional ser\'a tratada na pr\'oxima se\c{c}\~ao.
...
De forma bem suscinta, podemos recapitular que a coleta de dados de presen\c{c}a no \^ambito do projeto WASH se deu, inicialmente, por meio que podemos chamar de anal\'ogico: o registro em papel do nome das crian\c{c}as presentes, com a marca\c{c}\~ao da data caracter\'{\i}sticas dos eventos no topo da folha.
...
\item Perda de n\'umeros ou multiplicidade indevida de entrada de dados: isto pode gerar uma coluna de dados com menos ou mais dados do que o n\'umero original.
\end{alineas}
...
Dentre as vantagens s\~ao citadas (Brudner, 2022) :
...
\end{alineas}
 ...
 Brudner (2022) tamb\'em aponta as desvantagens das planilhas eletr\^onicas:
...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{A vis\~ao ou modelo relacional de dados descrita na se\c{c}\~ao 1 parece ser superior, em v\'arios aspectos, quando comparada com os modelos de grafo e de rede [3,4] presentemente em voga para sistemas n\~ao inferenciais. Ela prov\^e meios para descrever dados com estrutura puramente natural, ou seja, sem a super imposi\c{c}\~ao de uma estrutura adicional para a representa\c{c}\~ao dos dados no m\'aquina. Assim, obt\'em-se as bases para uma linguagem de dados de alto n\'{\i}vel, que prov\^e a m\'axima independ\^encia entre programas de um lado e a representa\c{c}\~ao e organiza\c{c}\~ao dos dados de outro. (Tradu\c{c}\~ao Livre de  CODD (1970))}\normalize}}}\end{center}


A frase acima indica uma busca por uma representa\c{c}\~ao dos dados que fosse independente da representa\c{c}\~ao espec\'{\i}fica numa m\'aquina em particular. Ou seja, Codd buscou uma forma de abstrair a representa\c{c}\~ao dos dados, sem ter que se preocupar como a m\'aquina os guardava, criando a possibilidade de independ\^encia do tipo de computador, sistema operacional ou at\'e do tipo de software de gest\~ao de dados. Isto tornou a armazenagem de dados muito mais flex\'{\i}vel, robusta e auto-consistente. Por auto-consistente podemos entender dados que dificilmente poder\~ao sobre corrup\c{c}\~oes, porque o pr\'oprio sistema \'e preparado para evitar dados indevidos.
...
Esta regra pode confundir as pessoas, levando-as a pensar que, como as planilhas eletr\^onicas s\~ao tabelas, elas tamb\'em s\~ao bancos de dados relacionais, mas isto n\~ao \'e verdade, como ficar\'a claro pelas demais regras.
...
\begin{table}[Htb]
\caption{\label{a8397969db05eaba803013476324bfe9b2b94efb}Exemplo de tabela de um banco de dados relacional.}
...
Como se v\^e, uma tabela no sentido de banco de dados relacionais \'e exatamente o que vem \`a mente quando uma pessoa sem forma\c{c}\~ao na \'area imagina.
...
Um banco de dados relacional, normalmente, tem muitas tabelas ao mesmo tempo e elas precisam seguir algumas regras para que sejam consideradas como parte de um banco de dados relacional.
...
\begin{table}[htb]
\caption{\label{a8397969db05eaba803013476324bfe9b2b94efb}Exemplo de tabela de um banco de dados relacional: cadastro de pessoas.}
...
\begin{table}[htb]
\caption{\label{a63c520e863da15e86e9e48af47b021078926fc7}Tabela de cidades num banco de dados relacional.}
...
\begin{table}[htb]
\caption{\label{d96a61f7f5e0d4d968398491b407ba7ac081ed8a}Tabela para a representa\c{c}\~ao de pessoas num banco de dados relacional}
...
\begin{table}[htb]
\caption{\label{e5cf179ae59583298aebd0b2a2e840b9804c6758}Vis\~ao parcial da tabela cargos da base de dados do WASH. A tabela completa tem 42 linhas com registros de cargos.}
...
\begin{table}[htb]
\caption{\label{b06e02c80db14444111aca53b54190b29e3e2bac}Vis\~ao parcial da tabela instituicoes da base de dados do WASH. A tabela completa tem 150 linhas com registros de institui\c{c}\~oes. Na presente reprodu\c{c}\~ao foram selecionados registros que mostram a pluralidade do atendimento do WASH, tendo sido retirados as repeti\c{c}\~oes de tipos de institui\c{c}\~oes por motivos de espa\c{c}o.}
