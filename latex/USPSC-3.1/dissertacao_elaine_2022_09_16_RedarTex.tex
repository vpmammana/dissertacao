...
\chapter[FUNDAMENTA\c{C}\~AO TE\'ORICA ]{FUNDAMENTA\c{C}\~AO TE\'ORICA }\label{FUNDAMENTA\c{C}\~AO TE\'ORICA }
Neste cap\'{\i}tulo buscaremos a fundamenta\c{c}\~ao para a vindoura escolha dos m\'etodos que ser\~ao empregados para alcan\c{c}ar os objetivos deste trabalho nos 3 eixos indicados:
...
Modelagem \'e a atividade de fazer modelos, que representam  o resultado principal da aplica\c{c}\~ao do m\'etodo cientifico. Entendemos que essa abordagem se faz necess\'aria para o processo de caracteriza\c{c}\~ao do Programa WASH para tanto nos reportaremos aos conceitos de Stezer quanto a dados, informa
...
Por esta raz\~ao, uma grande parte do esfor\c{c}o deste trabalho, conduzido principalmente no cap\'{\i}tulo de Materiais e M\'etodos no \^ambito do eixo 2, \'e de buscar entender como os dados devem ser estruturados, para que representem a ess\^encia do projeto, convers\'{\i}vel em informa\c{c}\~oes \'uteis para a avalia\c{c}\~ao, gest\~ao, reprodu\c{c}\~ao e longevidade do mesmo.
...
\begin{alineas}
\item Modelagem de entidades e associa\c{c}\~oes, an\'aloga a uma Modelagem Entidade Relaciomento (MER), mas limitada ao n\'{\i}veis de abstra\c{c}\~ao descritivo, com a integra\c{c}\~ao de alguns elementos do n\'{\i}vel de abstra\c{c}\~ao conceitual (Setzer e Silva, 2017)
\item Modelagem de Processos, no formato de Business Process Model Notation (BPMN)
\end{alineas}
...
Entretanto, a descri\c{c}\~ao baseada exclusivamente neste n\'{\i}vel de abstra\c{c}\~ao (descritivo) n\~ao foi suficiente para garantir a clareza que desej\'avamos. Por esta raz\~ao, decidimos complement\'a-la com Diagramas Entidade-Relacionamento simples, a exemplo dos que s\~ao mostrados nas Figs. XXX e XXX.
