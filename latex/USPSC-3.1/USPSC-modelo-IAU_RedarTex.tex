...
Os resultados est\~ao organizados, inicialmente, em tr\^es se\c{c}\~oes separadas, relacionadas \`as tr\^es dimens\~oes em an\'alise neste texto:
...
\begin{alineas}
\item Plataforma Platu\'osh
\item Plataforma de Planejamento Financeiro do Projeto WASH
\item Planilhas digitais de dados constru\'{\i}das pela candidata manualmente (sem uso do sistema de entrada de dados automatizado)
\end{alineas}

\subsection[Amostragem do p\'ublico atendido]{Amostragem do p\'ublico atendido}\label{Amostragem do p\'ublico atendido}
Antes de prosseguir \'e preciso explicitar que os indicadores utilizados neste projeto foram obtidos por amostragem, uma vez que o Projeto WASH tem limita\c{c}\~oes na coleta de dados cadastrais de participantes.
...
Portanto, tem ocorrido a falta de registro, nos arquivos do WASH, dos participantes que est\~ao sob cust\'odia da Entidade Respons\'avel. Esta situa\c{c}\~ao se intensificou a partir da edi\c{c}\~ao da Lei Geral de Prote\c{c}\~ao de Dados [XXX]. Tudo indica que as responsabilidades impostas aos gestores escolares por essa lei t\^em aumentado a  resist\^encia, por parte dos parceiros, em compartilhar informa\c{c}\~oes de participa\c{c}\~ao dos estudantes, o que \'e perfeitamente compreens\'{\i}vel.
...
Em termos de recorte temporal, os dados aqui apresentados referem-se ao per\'{\i}odo de 2013 (quando o WASH foi criado) at\'e o dia 26 de outubro de 2022, quando foi feita uma c\'opia da base de dados visando a an\'alise.
...
\begin{alineas}
\item as repeti\c{c}\~oes de nomes identificadas na base s\~ao bastante incomuns, incluindo formas estrangeiras de nomes pr\'oprios combinadas, o que afasta a hip\'otese de hom\^onimos. Este fato, por si s\'o seria um indicativo de que provavelmente estas repeti\c{c}\~oes se referem \`a mesma pessoa.
...
Um outro aspecto que precisa ser bastante enfatizado \'e que o n\'umero efetivo de participantes no WASH \'e provavelmente substancialmente maior do que 3265 registrados, ao contr\'ario do que est\'a registrado na plataforma.
...
\subsection[Evolu\c{c}\~ao temporal de participantes]{Evolu\c{c}\~ao temporal de participantes}\label{Evolu\c{c}\~ao temporal de participantes}
...
Foi comentado, tamb\'em, que em muitos casos os parceiros preferem n\~ao compartilhar dados de estudantes, mudando o perfil de coleta de dados amostrais por parte do WASH.
...
Mesmo com essas dificuldades, os dados amostrais s\~ao importante para identificar tend\^encias do projeto, a exemplo da evolu\c{c}\~ao anual no n\'umero de participantes, mostrada abaixo:
...
\begin{figure}[htb]
	...
	\caption{\label{output-eventos}Evolu\c{c}\~ao temporal do n\'umero de eventos ao longo dos 10 anos de exist\^encia do Projeto WASH.}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}{\textheight}]{../../imagens/participantes-por-genero.png}

	\end{center}

	\caption{\label{participantes-por-genero}@[caption-participantes-por-genero]@}

	\legend{Fonte: \citeonline{cite-participantes-por-genero}}
...
\subsection[N\'umero de Relat\'orios]{N\'umero de Relat\'orios}\label{N\'umero de Relat\'orios}
participantes
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}{\textheight}]{../../imagens/distribuicao-dos-eventos-ao-longo-dos-anos-menor.png}

	\end{center}

	\caption{\label{distribuicao-dos-eventos-ao-longo-dos-anos-menor}@[caption-distribuicao-dos-eventos-ao-longo-dos-anos-menor]@}

	\legend{Fonte: \citeonline{cite-distribuicao-dos-eventos-ao-longo-dos-anos-menor}}
