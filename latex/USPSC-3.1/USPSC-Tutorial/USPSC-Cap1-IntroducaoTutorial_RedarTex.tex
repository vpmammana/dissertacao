...
Atualmente a USP em S\~ao Carlos possui a Prefeitura do Campus USP de S\~ao Carlos (PUSP-SC), o Centro de Divulga\c{c}\~ao Cient\'{\i}fica e Cultural (CDCC) e as seguintes Unidades de ensino e pesquisa: Escola de Engenharia de S\~ao Carlos (EESC), Faculdade de Educa\c{c}\~ao\^encias Matem\'aticas e de Computa\c{c}\~ao (ICMC), Faculdade de Educa\c{c}\~ao\'{\i}sica de S\~ao Carlos (IFSC), Faculdade de Educa\c{c}\~ao\'{\i}mica de S\~ao Carlos (IQSC) e o Faculdade de Educa\c{c}\~ao.
