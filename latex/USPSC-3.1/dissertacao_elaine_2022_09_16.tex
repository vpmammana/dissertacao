...
% ---
\chapter[ORGANIZA\c{C}\~AO DESTE TRABALHO teste2]{ORGANIZA\c{C}\~AO DESTE TRABALHO teste2}\label{ORGANIZA\c{C}\~AO DESTE TRABALHO teste2}
...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{"Tinhamos  a certeza de que quando os computadores se tornassem t\~ao comuns quanto ao l\'apis a educa\c{c}\~ao mudaria t\~ao r\'apida e profundamente quanto as transforma\c{c}\~oes pelas quais viv\'{\i}amos nos direitos civis e nas rela\c{c}\~oes sociais e sexuais. [XXX colocar a cita\c{c}\~ao aqui]}\normalize}}}\end{center}
...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{"(...) informa\c{c}\~ao \'e representada pelo aumento de v\'{\i}nculos casuais que constituem os indiv\'{\i}duos (...). Estes v\'{\i}nculos foram constru\'{\i}dos pela evolu\c{c}\~ao e sele\c{c}\~ao natural para melhorar o preparo do indiv\'{\i}duo no enfrentamento dos perigos ambientais e possibilidades, de forma a aumentar a probabilidade de sobreviv\^encia de seus genes." (tradu\c{c}\~ao livre de  MAMMANA (1999))}\normalize}}}\end{center}
...
\begin{minipage}[b]{0.4\linewidth}
        \centering
                ...
                \label{dia-das-criancas-2022-10-03-menor}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.4\linewidth}
        \centering
                ...
                \label{confraternizacao-de-natal-menor}
\end{minipage}%
\hspace{0.5cm}
\begin{minipage}[b]{0.4\linewidth}
        \centering
                ...
                \label{Evento-Greenk-2018-05-27}
\end{minipage}
\hspace{0.5cm}
\begin{minipage}[b]{0.4\linewidth}
        \centering
...
\begin{minipage}[b]{0.4\linewidth}
        \centering
                ...
                \label{output-media-participacoes}
\end{minipage}%
\hspace{0.5cm}
\end{figure}
