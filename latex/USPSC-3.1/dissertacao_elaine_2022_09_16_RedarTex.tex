...
O Objetivo geral \'e estudar e caracterizar o Programa Workshop de Aficionados em Software e Hardware (WASH) em 3 eixos: (1) sua hist\'oria, (2) sua modelagem e (3) seus indicadores.
...
\item Hip\'otese 2: O WASH estimula aprendizagem por meio da orienta\c{c}\~ao a projetos para alunos do ensino m\'edio, t\'ecnico e de gradua\c{c}\~ao. Para verificar essa hip\'otese, ser\~ao levantados os perfis das atividades realizadas pelos estudantes, usando a aplica\c{c}\~ao dos m\'etodos do eixo 3, que permitir\~ao classificar em tem\'aticas os planos de trabalho apresentados para obten\c{c}\~ao das bolsas de inicia\c{c}\~ao cient\'{\i}fica.
...
\item Hip\'otese 7: O Modelo de Dados Relacional (MDR) da Plataforma de Gest\~ao do WASH (Platu\'oxe) precisa ser revisto, dado que segue apenas parcialmente as normas de bancos de dados relacionais. Para verificar essa hip\'otese ser\~ao usados os m\'etodos desenvolvidos no \^ambito do eixo 2, que permitir\~ao comparar as caracter\'{\i}sticas do modelo descritivo aqui desenvolvido com as do MDR desenvolvido no \^ambito da Platu\'oxe.
\item Hip\'otese 8: O Programa WASH tem v\'{\i}nculo com a administra\c{c}\~ao p\'ublica federal, mas estabelece pontes com os demais entes federados, com os poderes executivo e legislativo, com as redes de ensino, com os \'org\~aos de fomento cient\'{\i}fico e com as organiza\c{c}\~oes sociais. Para a demonstra\c{c}\~ao desta hip\'otese ser\~ao usados os m\'etodos do eixo 1, 2 e 3.
\item Hip\'otese 9: Em termos organizacionais, o WASH \'e estruturado na forma de heterarquia; uma pr\'atica sem organograma e que, por ora, ocorre em rede, de forma distribu\'{\i}da, sem institucionalidade definida. Para demonstrar esta hip\'otese usaremos os m\'etodos desenvolvidos nos eixos 1, 2 e 3.
\end{alineas}
...
\chapter[FUNDAMENTA\c{C}\~AO TE\'ORICA ]{FUNDAMENTA\c{C}\~AO TE\'ORICA }\label{FUNDAMENTA\c{C}\~AO TE\'ORICA }
\ul{Neste cap\'{\i}tulo buscaremos a fundamenta\c{c}\~ao para a vindoura escolha dos m\'etodos que ser\~ao empregados para alcan\c{c}ar os objetivos deste trabalho nos 3 eixos indicados:}
...
\section[Fundamenta\c{c}\~ao: hist\'oria (eixo 1)]{Fundamenta\c{c}\~ao: hist\'oria (eixo 1)}\label{Fundamenta\c{c}\~ao: hist\'oria (eixo 1)}
Para caracterizar e tra\c{c}ar a trajet\'oria (hist\'oria) do Programa WASH, em qual contexto ele surgiu, quais pol\'{\i}ticas, projetos, a\c{c}\~oes, enfim, as diversas experi\^encias de cultura digital que o antecederam (ver Hip\'oteses 3, 4, 6, 8 e 9), h\'a a necessidade de definir e aplicar um m\'etodo. Mas antes de defin\'{\i}-lo h\'a que se revisitar os conceitos pr\'e-existentes, trabalho que se desenvolver\'a nesta se\c{c}\~ao.
...
Assim, nesta se\c{c}\~ao, complementada pelo Ap\^endice I, ser\'a revisitada a base te\'orica das pr\'aticas historiogr\'aficas dispon\'{\i}veis para construir as narrativas sobre atividades e conceitos que antecederam a exist\^encia do Programa WASH, a exemplo do GESAC, OLPC e o Pensamento de Papert. Essas narrativas ser\~ao a base para  confirmar a hip\'otese de sua origem (Hip\'oteses 3 e 4). Esse percurso se dar\'a no contorno conceitual da Cultura Digital.
...
Para que nosso trabalho vinculado ao eixo 1 n\~ao ficasse sem uma identidade dentro do universo das tradi\c{c}\~oes historiogr\'aficas, decidimos fazer uma revis\~ao das principais escolas. Por outro lado, tal revis\~ao, ainda que muito resumida, mostrou-se por demais estensa para os objetivos deste trabalho, raz\~ao pela qual est\'a sendo apresentada no Ap\^endice A desta disserta\c{c}\~ao.
...
\ul{Modelagem \'e a atividade de fazer modelos, os quais est\~ao entre os  principais resultados da aplica\c{c}\~ao do m\'etodo cientifico. A palavra modelo tem origem no latim \textquotedbl modulus\textquotedbl , tendo assumido v\'arios significados ao longo dos s\'eculos   (SILVA e CATELLI, 2019). Segundo os autores o termo modelo come\c{c}ou a ser empregado no contexto cient\'{\i}fico pelos astr\^onomos, em substitui\c{c}\~ao ao termo sistema, quando se referiam ao sistema helioc\^entrico, por exemplo.  desde o seculo  Es que essa abordagem se faz necess\'aria para o processo de caracteriza\c{c}\~ao do Programa WASH para tanto nos reportaremos aos conceitos de Stezer quanto a dados, informa}
...
\ul{Modelagem \'e a atividade de fazer modelos, que representam  o resultado principal da aplica\c{c}\~ao do m\'etodo cientifico. Entendemos que essa abordagem se faz necess\'aria para o processo de caracteriza\c{c}\~ao do Programa WASH para tanto nos reportaremos aos conceitos de Stezer quanto a dados, informa}
...
\begin{table}[htb]
\tiny
\caption{\label{13d46f5e66a1eb6e7a5104c8143e7d2b0fc292b4}Compara\c{c}\~ao do investimento por hora por aluno nas escolas privadas e p\'ublicas. Os dados t\^em origem em v\'arias fontes regionais: Fundeb, DOU e Plataforma Campineira Melhor Escola. (Fonte:  [[MAMMANA et al. (2020)]])}
...
\begin{table}[htb]
\tiny
\caption{\label{c25b0d0d10f1c00152178ba636558c688e972ddd}Tradu\c{c}\~ao livre das palavras chave SQL associadas ao comando SELECT.}
