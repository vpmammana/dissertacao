...
% catalogação-na-publicação''. Voc\^e pode utilizar este modelo como refer\^encia. 
% Por\'em, provavelmente a biblioteca da sua universidade lhe fornecer\'a um PDF
% com a ficha catalogr\'afica definitiva após a defesa do trabalho. Quando estiver
	...
	\begin{tabular}{|p{0.9cm} p{8.7cm}|}
		\hline
		 ...
		 \imprimircutter & 
		  ...
		  &  % Para incluir nota referente `a versão corrigida no corpo da ficha,
		  ...
		  & 
		    \hspace{0.4cm}\imprimirnotaficha ~--~ 
		                  ...
		                  \imprimirdata. \\ 
		  & \\                 
		   % Para incluir nota referente `a versão corrigida em notas,
