...
%% by Luiz E. M. Lima
%% 
%% Modificado por Victor Pellegrini Mammana (MCTI) para permitir a automatização da geração do documento, através do projeto RedarTex
%%
...
\input{./utfprct-dados_RedarTex}%% Realize as modificações pertinentes no arquivo "utfprct-dados.tex"
...
%% Dedicatória
%%
\include{./PreTexto/dedicatoria_RedarTex}%% Comente para remover este item
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
