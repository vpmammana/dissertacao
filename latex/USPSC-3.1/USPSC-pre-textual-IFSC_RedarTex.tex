...
\ifthenelse{\equal{#1}{DFAe}}{
	...
	%\opcao{Nome da Opção}
   	% O preambulo deve conter o tipo do trabalho, o objetivo, 
   	% o nome da instituição, a área de concentração e opção quando houver
   	\preambulo{Thesis presented to the Graduate Program in Physics at the PROGRAMA DE P\'OS-GRADUA\c{C}\~AO EM ENSINO DE CI\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN, to obtain the degree of Doctor in Science.}
...
\ifthenelse{\equal{#1}{MFAe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Dissertation presented to the Graduate Program in Physics at the PROGRAMA DE P\'OS-GRADUA\c{C}\~AO EM ENSINO DE CI\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN, to obtain the degree of  Master in Science.}
...
\ifthenelse{\equal{#1}{DFAFBe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Thesis presented to the Graduate Program in Physics at the PROGRAMA DE P\'OS-GRADUA\c{C}\~AO EM ENSINO DE CI\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN da UNIVERSIDADE TECNOL\'OGICA FEDERAL DO PARAN\'A, to obtain the degree of Doctor in Science.}
	\notaficha{Thesis (Doctorate - Graduate Program in Applied Physics)}
    }{				
% MFAFBp ===========================================================================
...
% Outros
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao/Disserta\c{c}\~ao apresentada ao Programa de P\’{\o}s-Gradua\c{c}\~ao em F\’{\i}sica do PROGRAMA DE P\'OS-GRADUA\c{C}\~AO EM ENSINO DE CI\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN’{\i}sica de S\~ao Carlos da Universidade de S\~ao Paulo, para obtenç\c{c}\~ao do t\’{\i}tulo de Mestre/Doutor em Ci\^encias.}
