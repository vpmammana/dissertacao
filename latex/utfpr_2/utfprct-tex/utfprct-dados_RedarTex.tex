...
\NomeDoOrientador{Paulo Sérgio de Camargo Filho}%% Nome completo do(a) orientador(a)
\SobrenomeDoOrienador{Filho}%% \'Ultimo nome do(a) orientador(a)
\PrenomeDoOrientador{Paulo Sérgio de Camargo}%% Nome do(a) orientador(a) sem \'ultimo nome
...
\NomeDoCoorientador{Victor Pellegrini Mammana}%% Nome completo do(a) coorientador(a)
\SobrenomeDoCoorienador{Mammana}%% \'Ultimo nome do(a) coorientador(a)
\PrenomeDoCoorientador{Victor Pellegrini}%% Nome do(a) coorientador(a) sem \'ultimo nome
