...
Nossa modelagem MER foi fundamentalmente baseada na Portaria CTI 178/2018 e o seu anexo, que \'e o documento mais representativo de descri\c{c}\~ao do m\'etodo at\'e 2018.
...
Ainda no campo das \textquotedbl tenta\c{c}\~oes\textquotedbl , n\~ao seria de surpreender se algu\'em decidisse colocar o \textquotedbl tipo de documento\textquotedbl  como um atributo da entidade \textquotedbl Documentos\textquotedbl , mas vamos lembrar que, considerando a taxonomia de tipos de documentos, um certo documento pode ser do tipo \textquotedbl relat\'orio\textquotedbl  e do tipo \textquotedbl relat\'orio parcial\textquotedbl , ao passo que outro documento pode ser do tipo \textquotedbl relat\'orio\textquotedbl  e do tipo \textquotedbl relat\'orio final\textquotedbl , situa\c{c}\~ao que indica que um documento pode ser de v\'arios tipos, dentro de uma taxonomia. Em outras palavras, \'e mais oportuno representar o \textquotedbl tipo de um dado documento\textquotedbl  como uma associa\c{c}\~ao entre a entidade \textquotedbl Documentos\textquotedbl  e a entidade \textquotedbl Tipos de Documentos\textquotedbl .
...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{CTI, MIT, MEC, escola p\'ublicas, institui\c{c}\~ao de ensino, Institui\c{c}\~oes, IFSP, CNPq, escolas privadas, OLPC, org\~ao co-executor, \'org\~ao executor, Entidade Respons\'avel, Entidade Promotora}\normalize}}}\end{center}
...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{escola p\'ublicas, institui\c{c}\~ao de ensino, Institui\c{c}\~oes, escolas privadas,org\~ao co-executor, \'org\~ao executor, Entidade Respons\'avel, Entidade Promotora}\normalize}}}\end{center}
...
Como se ver\'a adiante, estas situa\c{c}\~oes indicam que \'e mais apropriado utilizar associa\c{c}\~oes para representar a institui\c{c}\~ao que promove um evento, como se ver\'a adiante.
