...
Neste trabalho buscamos utilizar a forma mais can\^onica de organiza\c{c}\~ao de um texto cient\'{\i}fico (KARA-JUNIOR, 2014), com as partes indicadas abaixo:
...
\end{figure}
\subsection[Dados da plataforma de planejamento]{Dados da plataforma de planejamento}\label{Dados da plataforma de planejamento}
participantes
