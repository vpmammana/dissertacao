...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/assinatura2.jpeg}

	\end{center}

	\caption{\label{assinatura2}Asssinatura do marmit\~ao.}

	\legend{Fonte: \citeonline{cite-assinatura2}}
...
\begin{figure}[htb]
	...
	\caption{\label{MEOS-Fish-Bone-Model-Basic-components-of-a-scientific-paper}A estrutura de ''espinha de peixe''  de S.A. MEOs (fonte: S.A.Meo [XXX Anatomy and physiology of a scientific paper])}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/precio-petroleo-1970-2015-800x403.jpg}

	\end{center}

	\caption{\label{precio-petroleo-1970-2015-800x403}Ganho no sal\'ario m\'{i}nimo com Lula.}

	\legend{Fonte: \citeonline{cite-precio-petroleo-1970-2015-800x403}}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/assinatura.jpeg}

	\end{center}

	\caption{\label{assinatura}@[caption-assinatura]@}

	\legend{Fonte: \citeonline{cite-assinatura}}
