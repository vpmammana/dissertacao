...
\ifthenelse{\equal{#1}{EAMB}}{
	...
	\preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Ambiental.}
...
\ifthenelse{\equal{#1}{EAER}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Aeron\'autico.}
...
\ifthenelse{\equal{#1}{ECIV}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Civil.}
...
\ifthenelse{\equal{#1}{ECOM}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da @[unidadefaculdade]@ e @[unidadefaculdade]@}\~ao da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro de Computa\c{c}\~ao.}
...
\ifthenelse{\equal{#1}{EELT}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
    % o nome da instituição, a área de concentração e opção quando houver
    \preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Eletricista.}
...
\ifthenelse{\equal{#1}{EELS}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Eletricista.}
...
\ifthenelse{\equal{#1}{EMAT}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
    % o nome da instituição, a área de concentração e opção quando houver
    \preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro de Materiais e de Manufatura.}
...
\ifthenelse{\equal{#1}{EMEC}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Mec\^anico.}
...
\ifthenelse{\equal{#1}{EMET}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
    % o nome da instituição, a área de concentração e opção quando houver
    \preambulo{Monografia apresentada ao @[curso]@, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro Mecatr\^onico.}
...
\ifthenelse{\equal{#1}{EPRO}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro de Produ\c{c}\~ao.}
...
% Outros
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@?), da @[unidadefaculdade]@ da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Engenheiro (?).}
