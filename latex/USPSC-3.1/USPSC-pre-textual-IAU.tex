...
\notabib{Ficha catalogr\'afica elaborada pela Biblioteca do @[curso]@- IAU/USP, com os dados fornecidos pelo(a) autor(a)}

\newcommand{\programa}[1]{@[programa]@}
...
\ifthenelse{\equal{#1}{DAUT}}{
	...
	\preambulo{Tese apresentada ao @[unidadefaculdademaiuscula]@@[curso]@, @[universidade]@, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de Doutor em Arquitetura e Urbanismo.}
...
\ifthenelse{\equal{#1}{MAUT}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição e a área de concentração 
	\preambulo{Disserta\c{c}\~ao apresentada ao @[unidadefaculdademaiuscula]@@[curso]@, @[universidade]@, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de Mestre em Arquitetura e Urbanismo.}
...
% Outros
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição e a área de concentração 
	\preambulo{Disserta\c{c}\~ao/Tese apresentada ao @[unidadefaculdademaiuscula]@@[curso]@, @[universidade]@, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de Mestre/Doutor em Arquitetura e Urbanismo.}
