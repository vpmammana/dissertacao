...
\ifthenelse{\equal{#1}{DFAp}}{
	...
	\preambulo{Tese apresentada ao @[unidadefaculdademaiuscula]@@[curso]@@[universidade]@, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias.}
...
\ifthenelse{\equal{#1}{DFAe}}{
	...
	%\opcao{Nome da Opção}
   	% O preambulo deve conter o tipo do trabalho, o objetivo, 
   	% o nome da instituição, a área de concentração e opção quando houver
   	\preambulo{Thesis presented to the Graduate Program in Physics at the @[curso]@@[universidade]@, to obtain the degree of Doctor in Science.}
...
\ifthenelse{\equal{#1}{MFAp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada ao @[unidadefaculdademaiuscula]@@[curso]@@[universidade]@, para obten\c{c}\~ao do t\'itulo de Mestre em Ci\^encias.}
...
\ifthenelse{\equal{#1}{MFAe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Dissertation presented to the Graduate Program in Physics at the @[curso]@@[universidade]@, to obtain the degree of  Master in Science.}
...
% Outros
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao/Tese apresentada ao Programa de P\’{\o}s-Gradua\c{c}\~ao em F\’{\i}sica do @[curso]@’{\i}sica de S\~ao Carlos da @[universidade]@, para obtenç\c{c}\~ao do t\’{\i}tulo de Mestre/Doutor em Ci\^encias.}
