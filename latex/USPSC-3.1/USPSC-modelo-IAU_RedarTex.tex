...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-MEOS}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-Herodote}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-ranke}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-dia-das-criancas-2022-10-03-menor}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-confraternizacao-de-natal-menor}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-Evento-Greenk-2018-05-27}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-MAAS}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-Ciencia-em-Show-prado}}

\end{figure}
Com os registros at\'e aqui apresentados, n\~ao exaustivos, uma vez que foram selecionados apenas 7 exemplos num universo de perto de mil eventos, buscamos sustentar a afirma\c{c}\~ao de que os 3265 cadastros de participantes representa uma amostra de todos os benefici\'arios do Projeto WASH.
...
Foi comentado, tamb\'em, que em muitos casos os parceiros preferem n\~ao compartilhar dados cadastrais e de participa\c{c}\~ao de estudantes por raz\~oes de seguran\c{c}a de dados, tendo sido observado um crescimento nessa tend\^encia ao longo dos anos do projeto. Tal evolu\c{c}\~ao tem mudando o perfil de coleta de dados amostrais por parte do WASH.
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-output-participantes}}
...
N\'umero de participa\c{c}\~oes significa o n\'umero de vezes que participantes frequentaram eventos do WASH naquele ano, mesmo que seja contabilizada a mesma pessoa duas vezes.
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-output-participantes2}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-output-media-participacoes}}
...
A afirma\c{c}\~ao de que existe um equil\'{\i}brio \'e de car\'ater amostral e n\~ao absoluto, podendo haver situa\c{c}\~oes em que para determinada faixa et\'aria, um g\^enero prevalece sobre o outro.
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-genero-todos-crop}}
...
\begin{alineas}
\item o balan\c{c}o entre o n\'umero de crian\c{c}as e adolescentes atendidos e n\'umero de membros atuantes no projeto
...
Mas a experi\^encia desta candidata no apoio \`a implementa\c{c}\~ao de bolsas no \^ambito do Projeto WASH indicava um n\'umero muito maior de bolsistas.
...
Uma reflex\~ao sobre os motivos desta inadequa\c{c}\~ao levaram ao seguinte conjunto de reflex\~oes:
...
Esta variabilidade nos dados de n\'umero de bolsistas gerou-nos uma inseguran\c{c}a em rela\c{c}\~ao \`a plataforma Platu\'osh no que tange aos dados de bolsistas. Assim, fomos motivados a  a buscar uma solu\c{c}\~ao independente de levantamento de dados de bolsas, uma vez que o v\'{\i}nculo dos bolsistas com o CNPq \'e formal e ocorre mediante Termo de Outorga, havendo meios de obter dados absolutos e n\~ao-amostrais, como os que s\~ao fornecidos pela Platu\'osh.
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-output-eventos}}
...
\begin{figure}[htb]
	...
	\legend{Fonte: \citeonline{cite-histograma-de-idades-no-ano-do-evento}}
...
% Ap\^endices
% ----------------------------------------------------------
\include{USPSC-TA-PosTextual/USPSC-Apendices_RedarTex}
