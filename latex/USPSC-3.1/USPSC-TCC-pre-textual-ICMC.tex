...
\ifthenelse{\equal{#1}{BCCe}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper submitted to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Computer Science.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
 ...
 \ifthenelse{\equal{#1}{BCCp}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
    % o nome da instituição, a área de concentração e opção quando houver
    \preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
    \preambuloadic{Conclusion course paper submitted to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Computer Science.}
...
\ifthenelse{\equal{#1}{BMe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course  paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Mathematics.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
...
\ifthenelse{\equal{#1}{BMp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\preambuloadic{Conclusion course  paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Mathematics.}
...
\ifthenelse{\equal{#1}{BMAe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Applied Mathematics and Scientific Computing.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao Cient\'ifica.}	
...
\ifthenelse{\equal{#1}{BMAp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao Cient\'ifica.}	
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Applied Mathematics and Scientific Computing.}
...
\ifthenelse{\equal{#1}{LMe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Licentiate in Mathematics.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
...
\ifthenelse{\equal{#1}{LMp}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao, do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Licentiate in Mathematics.}
...
\ifthenelse{\equal{#1}{BCDe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the  requirements for the degree of the Bachelor in Data Science.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
...
\ifthenelse{\equal{#1}{BCDp}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Data Science.}
...
\ifthenelse{\equal{#1}{EBECDe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Graduation project presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Statistics and Data Science.}
	\preambuloadic{Projeto de gradua\c{c}\~ao apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}
...
\ifthenelse{\equal{#1}{EBECDp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Projeto de gradua\c{c}\~ao apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\preambuloadic{Graduation project presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Statistics and Data Science.}
...
\ifthenelse{\equal{#1}{BECDe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Statistics and Data Science.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\notaficha{Monograph (Undergraduate in Statistics and Data Science)}
...
\ifthenelse{\equal{#1}{BECDp}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}	
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Statistics and Data Science.}
...
\ifthenelse{\equal{#1}{BSIe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Information Systems.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}	
...
\ifthenelse{\equal{#1}{BSIp}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}	
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the Bachelor in Information Systems.}
...
\ifthenelse{\equal{#1}{ECe}}{
	...
	\instituicao{@[unidadefaculdade]@}\~ao, @[universidade]@; @[unidadefaculdade]@, @[universidade]@}	
	%\opcao{Nome da Opção em inglês}
	%\opcaoadic{Nome da Opção em português}
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, and the @[unidadefaculdade]@, @[universidade]@, in partial fulfillment of the requirements for the degree of the Computer Engineer.}
	\preambuloadic{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao e @[unidadefaculdade]@, @[universidade]@ - ICMC - EESC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
...
\ifthenelse{\equal{#1}{ECp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao Programa de Gradua\c{c}\~ao do @[unidadefaculdade]@}\~ao e @[unidadefaculdade]@, @[universidade]@ - ICMC - EESC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
	\preambuloadic{Conclusion course paper presented to the Undergraduate Program of the @[unidadefaculdade]@}\~ao, and the @[unidadefaculdade]@, @[universidade]@, in partial fulfillment of the requirements for the degree of the Computer Engineer.}
...
% Outros
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver				
	\preambulo{Trabalho de conclus\~ao de curso apresentado ao @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@...}
	\preambuloadic{Term paper submitted to the @[unidadefaculdade]@}\~ao, @[universidade]@ - ICMC/USP, in partial fulfillment of the requirements for the degree of the ...}
