...
\ifthenelse{\equal{#1}{DFAp}}{
	...
	\preambulo{Tese apresentada ao Programa de P\'os-Gradua\c{c}\~ao da UTFPR vinculado a Faculdade de Educa\c{c}\~aoUniversidade Tecnol\'ogica Federal do Paran\'a, para obten\c{c}\~ao do t\'itulo de Mestre em LicenciaturaMestre em Ci\^encias.}
...
\ifthenelse{\equal{#1}{DFAe}}{
	...
	%\opcao{Nome da Opção}
   	% O preambulo deve conter o tipo do trabalho, o objetivo, 
   	% o nome da instituição, a área de concentração e opção quando houver
   	\preambulo{Thesis presented to the Graduate Program in Physics at the Faculdade de Educa\c{c}\~aoUniversidade Tecnol\'ogica Federal do Paran\'a, to obtain the degree of Doctor in Science.}
...
\ifthenelse{\equal{#1}{MFAp}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada ao Programa de P\'os-Gradua\c{c}\~ao da UTFPR vinculado a Faculdade de Educa\c{c}\~aoUniversidade Tecnol\'ogica Federal do Paran\'a, para obten\c{c}\~ao do t\'itulo de Mestre em LicenciaturaMestre em Ci\^encias.}
...
\ifthenelse{\equal{#1}{MFAe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Dissertation presented to the Graduate Program in Physics at the Faculdade de Educa\c{c}\~aoUniversidade Tecnol\'ogica Federal do Paran\'a, to obtain the degree of  Master in Science.}
...
\ifthenelse{\equal{#1}{DFAFBe}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Thesis presented to the Graduate Program in Physics at the Faculdade de Educa\c{c}\~ao, Universidade Tecnol\'ogica Federal do Paran\'a, to obtain the degree of Doctor in Science.}
	\notaficha{Thesis (Doctorate - Graduate Program in Applied Physics)}
    }{				
% MFAFBp ===========================================================================
...
% Outros
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao/Tese apresentada ao Programa de P\’{\o}s-Gradua\c{c}\~ao em F\’{\i}sica do Faculdade de Educa\c{c}\~ao’{\i}sica de S\~ao Carlos da Universidade Tecnol\'ogica Federal do Paran\'a, para obtenç\c{c}\~ao do t\’{\i}tulo de Mestre/Doutor em Ci\^encias.}
