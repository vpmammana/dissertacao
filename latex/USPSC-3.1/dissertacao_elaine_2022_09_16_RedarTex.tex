...
\begin{table}[Htb]
\tiny
\caption{\label{faec13da9804bf84b8d8d92b5adb5b3ca09db3f3}N\'{i}veis de abstra\c{c}\~oes}
...
\begin{alineas}
\item Modelagem de Entidade e Relacionamento (MER) adaptada ao n\'{\i}vel de abstra\c{c}\~ao descritivo (Setzer e Silva, 2017)
...
Portanto a nossa modelagem MER acabou por se mostrar h\'{\i}brida, intermedi\'aria entre o n\'{\i}vel descritivo e o conceitual.
...
Nossa modelagem MER foi fundamentalmente baseada na Portaria CTI 178/2018, que \'e o documento mais representativo de descri\c{c}\~ao do m\'etodo at\'e 2018.
...
Entretanto, por termos participado da concep\c{c}\~ao, planejamento, coordena\c{c}\~ao e execu\c{c}\~ao do Projeto WASH durante toda a sua exist\^encia, sabemos que seu documento de refer\^encia traz apenas um vis\~ao parcial do m\'etodo efetivamente aplicado.
...
Assim, o dinamismo da evolu\c{c}\~ao metodol\'ogica do WASH requer um acompanhamento do que de fato tem sido o projeto, para al\'em do documento de refer\^encia.
...
Esta lista ser\'a enriquecida por outros substantivos coletados no texto do Anexo \`a portaria. Estes substantivos ser\~ao analisados e agrupados em Entidades, para depois serem identificadas as associa\c{c}\~oes (relaciomentos) entre elas, como determina a Modelagem Entidade-Relacionamento.
...
\begin{table}[Htb]
\tiny
\caption{\label{d986a5b17016087e9a4b786805887181cf4a5d78}Substantivos extra\'{i}dos do texto do anexo da portaria 178 para a modelagem MER.}
...
Agora, por inspe\c{c}\~ao, vamos tentar identificar as entidades mais evidentes para a classifica\c{c}\~ao do universo de substantivos.
...
Explicamos, tamb\'em, que optamos por uma Modelagem Entidade-Relacionamento h\'{\i}brida, no sentido que ela se valeu da combina\c{c}\~ao de elementos do n\'{\i}veis de abstra\c{c}\~ao descritivo e conceitual. Esta combina\c{c}\~ao permitiu simplificar a representa\c{c}\~ao do modelo, utilizando a linguagem natural (portugu\^es) complementada por alguns diagramas simples do n\'{\i}vel conceitual.
