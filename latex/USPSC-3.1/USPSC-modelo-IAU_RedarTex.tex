...
\end{figure}
A estrutura de "espinha de peixe de S.A. MEOs (fonte: S.A.Meo [XXX Anatomy and physiology of a scientific paper])
...
\begin{figure}[htb]
	...
	\caption{\label{assinatura2}@[caption-assinatura2]@}

	\legend{Fonte: \citeonline{cite-assinatura2}}

\end{figure}
Asssinatura do marmit\~ao.
