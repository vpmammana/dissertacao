...
\noindent\begin{center}\mbox{\centering\fbox{\centering\par\parbox{0.7\linewidth}{\small\textit{(no n\'{\i}vel descritivo) as abstra\c{c}\~oes podem a abranger uma gama muito ampla, desde asse\c{c}\~oes logicamente perfeitas at\'e frases amb\'{\i}guas ou mesmo po\'eticas, contendo um simbolismo que transcende a experi\^encia sensorial direta. O importante \'e que haja uma descri\c{c}\~ao por meio de frases (ou outros meios como figuras e fotos), preferivelmente sem o uso de conceitos matematicamente formais, ou pelo menos com um m\'{\i}nimo deles (Setzer e Silva, 2017)}\normalize}}}\end{center}
...
\begin{table}[Htb]
\tiny
\caption{\label{4eebfed948d6b1423ddd912a740294b998f9c699}Lista de resultados (nomes fict\'{i}cios) para a consulta SQL de todos os participantes cujo primeiro nome \'e Paulo.}
...
Para chegar nesse ponto, governos tiveram que prover a infraestrutura de ci\^encia e tecnologia, comunica\c{c}\~oes e de redes digitais, bem como os meios de acesso a essas redes, algumas vezes com a participa\c{c}\~ao da iniciativa privada. Na outra ponta, tiveram que promover projetos, formular pol\'{\i}ticas p\'ublicas nos campos da ci\^encia, tecnologia e ind\'ustria.
...
\begin{table}[htb]
\tiny
\caption{\label{28240f30a95f9e5edeb063f50d342a9295cc3473}Exemplo de tabela de um banco de dados relacional: cadastro de pessoas.}
...
\begin{table}[htb]
\tiny
\caption{\label{405491894aeba952f27bd50e0f454131ae01e828}Tabela de cidades num banco de dados relacional.}
...
\begin{table}[htb]
\tiny
\caption{\label{4ad27c194e7261dba7be8091af3acf6d980927ab}Tabela para a representa\c{c}\~ao de pessoas num banco de dados relacional}
...
\begin{table}[htb]
\tiny
\caption{\label{6a32ad33b9a5514f195c6d160447d7731fd06bd0}Lista de resultados (nomes fict\'{i}cios) para a consulta SQL de todos os participantes cujo primeiro nome \'e Paulo.}
...
O conjunto de substantivos abaixo indica motiva a identifica\c{c}\~ao da entidade \textquotedbl Pessoas\textquotedbl :
...
Nota-se da lista acima que embora os substantivos se refiram a \textquotedbl pessoas\textquotedbl , carregam informa\c{c}\~ao sobre o papel ou tipo de vincula\c{c}\~ao, misturando informa\c{c}\~oes.
...
Para garantir a segrega\c{c}\~ao da informa\c{c}\~ao, como requer o MER, criaremos um outro tipo de entidade, denominada: \textquotedbl Tipos de Papeis\textquotedbl :
...
\begin{table}[htb]
\tiny
\caption{\label{12528506ea11d822f2bf5b3b5e9e76011a826f78}Vis\~ao parcial da tabela cargos da base de dados do WASH. A tabela completa tem 42 linhas com registros de cargos.}
...
\begin{table}[htb]
\tiny
\caption{\label{8daf06eaead71ecb793dbe9f14fb1d61e8f41876}Vis\~ao parcial da tabela instituicoes da base de dados do WASH. A tabela completa tem 150 linhas com registros de institui\c{c}\~oes. Na presente reprodu\c{c}\~ao foram selecionados registros que mostram a pluralidade do atendimento do WASH, tendo sido retirados as repeti\c{c}\~oes de tipos de institui\c{c}\~oes por motivos de espa\c{c}o.}
...
\begin{table}[htb]
\tiny
\caption{\label{cdf10ba3226b572e5509d2509d42edc4bfe135d5}Exemplo de linha da tabela participantes2, selecionada para que se possa entender como o registro dos papeis desempenhados por cada participante \'e feito no \^ambito do WASH. A tabela participantes2 tem 3312 registros de participantes.}
