...
\ifthenelse{\equal{#1}{EAMB}}{
	...
	\preambulo{Monografia apresentada ao Curso de P\'os-Gradua\c{c}\~ao em Licenciatura, da Faculdade de Educa\c{c}\~ao da Universidade Tecnol\'ogica Federal do Paran\'a, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Mestre em Licenciatura.}
...
\ifthenelse{\equal{#1}{ECOM}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao Curso de P\'os-Gradua\c{c}\~ao em Licenciatura}\~ao, da Faculdade de Educa\c{c}\~ao e Faculdade de Educa\c{c}\~ao}\~ao da Universidade Tecnol\'ogica Federal do Paran\'a, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Mestre em LicenciaturaMestre em Licenciatura}\~ao.}
...
\ifthenelse{\equal{#1}{EELS}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao Curso de P\'os-Gradua\c{c}\~ao em Licenciatura}\~ao, da Faculdade de Educa\c{c}\~ao da Universidade Tecnol\'ogica Federal do Paran\'a, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Mestre em Licenciatura.}
...
\ifthenelse{\equal{#1}{EPRO}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao Curso de P\'os-Gradua\c{c}\~ao em Licenciatura}\~ao, da Faculdade de Educa\c{c}\~ao da Universidade Tecnol\'ogica Federal do Paran\'a, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de Mestre em LicenciaturaMestre em Licenciatura}\~ao.}
