...
%% EESC - @[unidadefaculdade]@
%% IAU - @[unidadefaculdade]@}\~ao
%% ICMC - @[unidadefaculdade]@}\~ao
%% IFSC - @[unidadefaculdade]@}sica de S\~ao Carlos
%% IQSC - @[unidadefaculdade]@}mica de S\~ao Carlos
%%
...
Em outra ponta, os governos tiveram que formular pol\'{\i}ticas p\'ublicas disponibilizar e preparar os cidad\~aos para que pudessem se apropriar dessas tecnologias.
...
Essa expans\~ao deu-se como resultado de v\'arias a\c{c}\~oes, mas sua universaliza\c{c}\~ao foi resultado do surgimento de novas formas de relacionamento social viabilizadas pelas redes digitais, que tornaram mais acess\'{\i}veis novas ferramentas tais como  de apoio ao ensino em sala de aula, ao ensino \`a dist\^ancia, ao com\'ercio eletr\^onico, \`a elei\c{c}\~ao eletr\^onica, aos \textquotedbl market-places\textquotedbl , aos aplicativos de transporte e de  entrega, ao agendamento de eventos, de reuni\~oes e consultas m\'edicas, dentre tantos outros exemplos.
...
A avalia\c{c}\~ao do Projeto OLPC proporcionou uma resinifica\c{c}\~ao para a proposta, permitindo compreender mais profundamente os desafios do uso intensivo de Tecnologia da Informa\c{c}\~ao e Comunica\c{c}\~ao (TIC) no contexto da escola p\'ublica brasileira e, com isso, propor uma alternativa.
...
A abordagem adotada na presente disserta\c{c}\~ao se encaixa no m\'etodo de \textquotedbl Estudo de Caso\textquotedbl  e buscar\'a contar toda essa trajet\'oria que se inicia no que foi descrito aqui, bem como identificar o m\'etodo do Programa WASH e seus resultados. O documento fundamental a ser usado para permitir a caracteriza\c{c}\~ao do WASH \'e a Portaria CTI 178 e outros registros, tais como publica\c{c}\~oes, relat\'orios, planos de trabalho, produ\c{c}\~ao audiovisual, entre outras.
...
Para responder essa pergunta \'e preciso, inicialmente, adiantar que o WASH ocorre no \^ambito de projetos de inicia\c{c}\~ao cient\'{\i}fica e da extens\~ao junto ao CNPq, financiados por emendas parlamentares (ver a lista de emendas na se\c{c}\~ao XXX).
...
Decidimos utilizar como origem das hip\'oteses deste trabalho parte dos objetivos presentes na Portaria 178/2018 porque entendemos que \'e papel desta pesquisa verificar se eles foram alcan\c{c}ados. Assim, dentro desta abordagem, podemos dizer que verificar a validade de uma hip\'otese baseada nos objetivos da Portaria CTI 178/2018 \'e equivalente a verificar se aquele objetivo foi alcan\c{c}ado pelo objeto deste estudo, o Programa WASH.
...
Complementarmente aos objetivos da Portaria CTI 178/2018, enunciamos hip\'oteses adicionais com base em nosso conhecimento sobre o programa. As hip\'oteses obtidas a partir dessas duas origens foram organizadas na lista a seguir, sendo que para cada hip\'otese s\~ao identificados os eixos cujos resultados contribuir\~ao para sua verifica\c{c}\~ao:
...
O trabalho de verifica\c{c}\~ao das hip\'oteses, previsto nos objetvos desta disserta\c{c}\~ao e desenvolvido nas sub-se\c{c}\~oes a seguir, \'e imprescind\'{\i}vel para conhecer a efici\^encia e efic\'acia do WASH como programa de educa\c{c}\~ao.
...
\subsection[Hip\'otese 1: Efic\'acia do WASH]{Hip\'otese 1: Efic\'acia do WASH}\label{Hip\'otese 1: Efic\'acia do WASH}
O WASH conseguiu promover  a dissemina\c{c}\~ao de conhecimentos em Ci\^encia e Tecnologia, beneficiando milhares de pessoas em dezenas de cidades pela oferta de oficinas de curta dura\c{c}\~ao nos ensinos fundamental, m\'edio e superior.
...
O WASH estimula aprendizagem por meio da orienta\c{c}\~ao a projetos para alunos do ensino m\'edio, t\'ecnico e de gradua\c{c}\~ao em temas relacionados \`a Science, Technology, Engineering, Arts and Mathematics.
...
O WASH teve como origem as experi\^encias da avalia\c{c}\~ao do OLPC (NEGROPONTE, 2004), das pr\'aticas do Programa Governo Eletr\^onico de Servi\c{c}o de Atendimento ao Cidad\~ao (GESAC) e da Avalia\c{c}\~ao do Programa de Inclus\~ao Digital (PID) da Secretaria de Inclus\~ao Social (SECIS) do Minist\'erio da Ci\^encia e Tecnologia (CGEE, 2009).
...
O WASH se inspira em conceitos e pr\'aticas de Seymour Papert (PAPERT, 1980), combinados com outros m\'etodos, tendo se embasado, em parte, nas experi\^encias pioneiras da Profa. Dra. Afira Vianna Ripper, que foi figura chave na transposi\c{c}\~ao dos conceitos de Papert para o Brasil.
...
O WASH pode ser considerado como uma proto-pol\'{\i}tica p\'ublica nacional.
...
Em termos organizacionais, o WASH \'e estruturado na forma de heterarquia.
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/acesso-internet.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/evolucao-da-documentacao.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/antenagesac.jpg}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/computer-room.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/embaixo-mesa.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/primeiro-wash-corte.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/ponte-wash.png}
...
\begin{alineas}
\item @[universidademaiuscula]@ - USP - Portaria GR 7669, de 8/07/2021- Estabelece as condi\c{c}\~oes para a execu\c{c}\~ao do Programa WASH na @[universidade]@
...
Para determinar o n\'umero de bolsistas atuantes no Programa WASH, decidimos utilizar o Recorte B, aproveitando consultas estruturadas de car\'ater mais gen\'erico, aplicadas \`a Platu\'osh, desenvolvidas por Michel Alencar Morandi e publicadas em  WASH (2023).
...
Primeiramente, para verificar a abrang\^encia dos dados sobre bolsistas presentes no Recorte B da Platu\'osh, apresentamos a evolu\c{c}\~ao anual de concess\~ao de bolsas, mostrada na Fig. XXX.
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/bolsas-anualmente-recorte-b-crop.png}
...
\'E poss\'{\i}vel an\'alises de interesse para essa disserta\c{c}\~ao, mesmo considerando que os dados de bolsas, pelo Recorte B, est\~ao limitados aos anos de 2020 a 2023. Portanto, essas an\'alises s\~ao de car\'ater amostral.
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/quantidade-bolsistas-3.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/duracao-bolsas.png}
...
\begin{alineas}
\item plataforma Platu\'osh, que tem um car\'ater amostral e n\~ao exaustivo em termos de coleta de dados de documentos
...
\begin{figure}[Htb]
	...
	\caption{\label{8af5236ba8f91623157f8f95ae10366b416d6049}Evolu\c{c}\~ao anual do n\'umero de eventos realizados, obtida a partir do Recorte A.}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/eventos-ano-recorte-B.png}
...
\subsection[Tipos de Atividades realizadas nos eventos]{Tipos de Atividades realizadas nos eventos}\label{Tipos de Atividades realizadas nos eventos}
O tipo de atividade realizada \'e uma importante caracter\'{\i}stica dos eventos.
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/distribuicao-bolsistas-por-cidades.png}
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/eventos-cidades.png}
...
\subsection[Epis\'odios da web-s\'erie \textquotedbl Ci\^encia e Cultura Vamos Brincar?\textquotedbl ]{Epis\'odios da web-s\'erie \textquotedbl Ci\^encia e Cultura Vamos Brincar?\textquotedbl }\label{Epis\'odios da web-s\'erie \textquotedbl Ci\^encia e Cultura Vamos Brincar?\textquotedbl }
Consta do acervo do WASH a edi\c{c}\~ao de 9 epis\'odios da web-s\'erie \textquotedbl Ci\^encia e Cultura, Vamos Brincar?\textquotedbl  (CCVB). Esse programa, como j\'a explicado na se\c{c}\~ao XXX, foi criado como forma alternativa de promover a aprendizagem no contexto da pandemia, quando as oficinas presenciais n\~ao eram mais poss\'{\i}veis. O CCVB foi concebido por esta autora, que coordenou suas atividades.
...
\section[S\'{\i}ntese anal\'{\i}tica dos 2 eixos: verifica\c{c}\~ao de hip\'oteses]{S\'{\i}ntese anal\'{\i}tica dos 2 eixos: verifica\c{c}\~ao de hip\'oteses}\label{S\'{\i}ntese anal\'{\i}tica dos 2 eixos: verifica\c{c}\~ao de hip\'oteses}
Aqui ser\'a feita a s\'{\i}ntese das 2 dimens\~oes, atrav\'es da verifica\c{c}\~ao das hip\'oteses desta disserta\c{c}\~ao.
...
\subsection[Hip\'otese 2: Orienta\c{c}\~ao a Projetos]{Hip\'otese 2: Orienta\c{c}\~ao a Projetos}\label{Hip\'otese 2: Orienta\c{c}\~ao a Projetos}
Hip\'otese 2: O WASH estimula aprendizagem por meio da orienta\c{c}\~ao a projetos para alunos do ensino m\'edio, t\'ecnico e de gradua\c{c}\~ao de temas relacionados \`a Science, Technology, Engineering, Arts and Mathematics. O resultado do desenvolvimento desses projetos foi uma vasta produ\c{c}\~ao de conhecimentos e aprendizados.  Para verificar essa hip\'otese, ser\~ao levantados os perfis das atividades realizadas pelos estudantes, usando a aplica\c{c}\~ao dos m\'etodos do eixo 2, que permitir\~ao identificar a classifica\c{c}\~ao em tem\'aticas dos planos de trabalho apresentados para obten\c{c}\~ao das bolsas de inicia\c{c}\~ao cient\'{\i}fica. Al\'em disso, para verificar esta hip\'otese ser\~ao empregados os m\'etodos desenvolvidos no \^ambito do eixo 2, com foco em indicadores tais como a quantidade de documentos gerados, papers publicados e produ\c{c}\~oes audiovisuais, entre outras..
...
\subsection[Hip\'otese 3: Origem do WASH]{Hip\'otese 3: Origem do WASH}\label{Hip\'otese 3: Origem do WASH}
Hip\'otese 3: O WASH teve como origem as experi\^encias da avalia\c{c}\~ao do OLPC (NEGROPONTE, 2004), das pr\'aticas do Programa Governo Eletr\^onico de Servi\c{c}o de Atendimento ao Cidad\~ao (GESAC) e da Avalia\c{c}\~ao do Programa de Inclus\~ao Digital (PID) da Secretaria de Inclus\~ao Social (SECIS) do Minist\'erio da Ci\^encia e Tecnologia (CGEE, 2009). Esta hip\'otese ser\'a verificada atrav\'es do m\'etodo desenvolvido no eixo 1.
...
\subsection[Hip\'otese 5: WASH como proto-pol\'{\i}tica p\'ublica]{Hip\'otese 5: WASH como proto-pol\'{\i}tica p\'ublica}\label{Hip\'otese 5: WASH como proto-pol\'{\i}tica p\'ublica}
Hip\'otese 6: O WASH, que se iniciou como uma atividade volunt\'aria de oficinas de tecnologia aos finais de semana sem financiamento, foi concebido no seio de uma institui\c{c}\~ao de pesquisas federal (CTI Renato Archer), o que abriu uma oportunidade para execut\'a-lo na forma de projetos. A grande quantidade de projetos deu-lhe as caracter\'{\i}sticas de um programa, embora nunca tenha sido formalizado como tal na esfera federal.  Hoje pode ser considerado como uma proto-pol\'{\i}tica p\'ublica nacional. Para verificar essa hip\'otese ser\~ao empregados os m\'etodos desenvolvidos no \^ambito dos eixos 1 e 2, levantando o acervo de projetos, documentos de ades\~ao, legisla\c{c}\~ao, entre outros. O Programa WASH tem v\'{\i}nculo com a administra\c{c}\~ao p\'ublica federal, mas estabelece pontes com os demais entes federados, com os poderes executivo e legislativo, com as redes de ensino, com os \'org\~aos de fomento cient\'{\i}fico e com as organiza\c{c}\~oes sociais. Para a demonstra\c{c}\~ao desta hip\'otese ser\~ao usados os m\'etodos do eixo 1 e 2.
...
\subsection[Hip\'otese 6: WASH como organiza\c{c}\~ao heter\'arquica]{Hip\'otese 6: WASH como organiza\c{c}\~ao heter\'arquica}\label{Hip\'otese 6: WASH como organiza\c{c}\~ao heter\'arquica}
Hip\'otese 8: Em termos organizacionais, o WASH \'e estruturado na forma de heterarquia; uma pr\'atica sem organograma e que, por ora, ocorre em rede, de forma distribu\'{\i}da, sem institucionalidade definida. Para demonstrar esta hip\'otese usaremos os m\'etodos desenvolvidos nos eixos 1 e 2.
...
\begin{flushleft}
\begin{flushleft}
[Rodrigues, 2010] Rodrigues, Z.M.R. Sistema de indicadores e desigualdade socioambiental intraurbana de S\~ao Lu\'{\i}z-MA, Tese de Doutorado, Orientador: Prof. Dr. Wagner Costa Ribeiro, Programa de P\'os-Gradua\c{c}\~ao da @[universidade]@, 2010
\end{flushleft}
...
\begin{flushleft}
\begin{flushleft}
[MEADOWS, 2006] Meadows, D. apud: Indicators and information Systems for sustainable development. The Sustainability Institute, 1998, In: WORKSHOP INTERNACIONAL PESQUISA EM INDICADORES DE SUSTENTABILIDADE. S\~ao Paulo, @[unidadefaculdade]@, 2006.
\end{flushleft}
...
\begin{flushleft}
\begin{flushleft}
[DOSSE, 2012] Dosse, F. Hist\'oria do tempo presente e historiografia, Tempo e Argumento, Revista do @[programapos]@, Florion\'opolis, v. 4, n. 1, p. 5-22, jan/jun 2022
\end{flushleft}
