...
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[tituloabstract\]@/HISTORY AND CHARACTERIZATION OF A DECADE OF WASH: A HETERARCHIAL STEAM EDUCATION PROGRAM/g\" "$0}' > ../bash/substitui_tex_6.bash
../bash/substitui_tex_6.bash

touch ../bash/substitui_tex_7.bash
chmod u+x ../bash/substitui_tex_7.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[orientador\]@/Prof. Dr. Paulo S\\\\\\"acute"ergio de Camargo Filho/g\" "$0}' > ../bash/substitui_tex_7.bash
...
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[coorientador\]@/Dr. Victor Pellegrini Mammana/g\" "$0}' > ../bash/substitui_tex_9.bash
../bash/substitui_tex_9.bash

touch ../bash/substitui_tex_10.bash
chmod u+x ../bash/substitui_tex_10.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[programapos\]@/PROGRAMA DE P\\\\\\"acute"OS-GRADUA\\\\\\c{C}\\\\\~AO EM ENSINO DE CI\\\\\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN/g\" "$0}' > ../bash/substitui_tex_10.bash
../bash/substitui_tex_10.bash

touch ../bash/substitui_tex_11.bash
chmod u+x ../bash/substitui_tex_11.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[programaposmaiuscula\]@/PROGRAMA DE P\\\\\\"acute"OS-GRADUA\\\\\\c{C}\\\\\~AO EM ENSINO DE CI\\\\\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN/g\" "$0}' > ../bash/substitui_tex_11.bash
../bash/substitui_tex_11.bash

touch ../bash/substitui_tex_12.bash
chmod u+x ../bash/substitui_tex_12.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[mestreoudoutor\]@/Mestre/g\" "$0}' > ../bash/substitui_tex_12.bash
../bash/substitui_tex_12.bash

touch ../bash/substitui_tex_13.bash
chmod u+x ../bash/substitui_tex_13.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[titulopos\]@/Mestre em Ensino de Ci\\\\\^encias Humanas, Sociais e da Natureza/g\" "$0}' > ../bash/substitui_tex_13.bash
../bash/substitui_tex_13.bash

touch ../bash/substitui_tex_14.bash
chmod u+x ../bash/substitui_tex_14.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[universidade\]@/UNIVERSIDADE TECNOL\\\\\\"acute"OGICA FEDERAL DO PARAN\\\\\\"acute"A/g\" "$0}' > ../bash/substitui_tex_14.bash
../bash/substitui_tex_14.bash

touch ../bash/substitui_tex_15.bash
chmod u+x ../bash/substitui_tex_15.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[universidademaiuscula\]@/UNIVERSIDADE TECNOL\\\\\\"acute"OGICA FEDERAL DO PARAN\\\\\\"acute"A/g\" "$0}' > ../bash/substitui_tex_15.bash
../bash/substitui_tex_15.bash

touch ../bash/substitui_tex_16.bash
chmod u+x ../bash/substitui_tex_16.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[unidadefaculdade\]@/PROGRAMA DE P\\\\\\"acute"OS-GRADUA\\\\\\c{C}\\\\\~AO EM ENSINO DE CI\\\\\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN/g\" "$0}' > ../bash/substitui_tex_16.bash
../bash/substitui_tex_16.bash

touch ../bash/substitui_tex_17.bash
chmod u+x ../bash/substitui_tex_17.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[unidadefaculdademaiuscula\]@/PROGRAMA DE P\\\\\\"acute"OS-GRADUA\\\\\\c{C}\\\\\~AO EM ENSINO DE CI\\\\\^ENCIAS HUMANAS, SOCIAIS E DA NATUREZA - PPGEN/g\" "$0}' > ../bash/substitui_tex_17.bash
../bash/substitui_tex_17.bash

touch ../bash/substitui_tex_18.bash
chmod u+x ../bash/substitui_tex_18.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[localidade\]@/LONDRINA 2023/g\" "$0}' > ../bash/substitui_tex_18.bash
../bash/substitui_tex_18.bash

touch ../bash/substitui_tex_19.bash
chmod u+x ../bash/substitui_tex_19.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[palavraschave\]@/Papert, STEAM, STEM, WASH/g\" "$0}' > ../bash/substitui_tex_19.bash
...
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[dedicatoria\]@/Dedico esta disserta\\\\\\c{c}\\\\\~ao aos meus genitores: Maria Imaculada de Oliveira Silva e Joaquim Roberto da Silva./g\" "$0}' > ../bash/substitui_tex_21.bash
../bash/substitui_tex_21.bash

touch ../bash/substitui_tex_22.bash
chmod u+x ../bash/substitui_tex_22.bash
find ../../latex/* | grep -i "\_RedarTex.tex" | awk -v acute="'" -v tilde="~" '{print "sed -i \"s/@\[ano\]@/2023/g\" "$0}' > ../bash/substitui_tex_22.bash
