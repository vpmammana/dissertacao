...
Neste trabalho buscamos utilizar a forma mais can\^onica de estrutura\c{c}\~ao de um texto cient\'{\i}fico (KARA-JUNIOR, 2014), com as partes indicadas abaixo:
...
Uma forma diferente de expressar esses mesmos conceitos \'e:
...
\begin{alineas}
\item atribuir a pergunta "por que fiz?" \`a Introdu\c{c}\~ao,
\item atribuir a pergunta "como fiz?" aos M\'etodos
\item e atribuir a pergunta "o que obtive?" aos Resultados
\end{alineas}

Desta forma, o mesmo objeto de estudo pode ser observado por meio de 3 dimens\~oes que se complementam.
...
A estrutura\c{c}\~ao por perguntas indicada no par\'agrafo acima pode ter variantes mais completas, como a descrita em BATES (2014):
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/MEOS.png}
...
\section[Caracter\'{\i}sticas da Introdu\c{c}\~ao]{Caracter\'{\i}sticas da Introdu\c{c}\~ao}\label{Caracter\'{\i}sticas da Introdu\c{c}\~ao}
...
\section[Caracter\'{\i}sticas de Materiais e M\'etodos]{Caracter\'{\i}sticas de Materiais e M\'etodos}\label{Caracter\'{\i}sticas de Materiais e M\'etodos}
...
\section[Caracter\'{\i}sticas de Resultados e Discuss\~oes]{Caracter\'{\i}sticas de Resultados e Discuss\~oes}\label{Caracter\'{\i}sticas de Resultados e Discuss\~oes}
...
\section[Caracter\'{\i}sticas de Produto Tecnol\'ogico]{Caracter\'{\i}sticas de Produto Tecnol\'ogico}\label{Caracter\'{\i}sticas de Produto Tecnol\'ogico}
...
Essas ferramentas s\~ao continuamente revistas e melhoradas, assim como n\~ao param de se multiplicar para atender e se adaptar aos desafios impostos pela evolu\c{c}\~ao da conviv\^encia em sociedade. Um exemplo dessa necessidade de adapta\c{c}\~ao foi recentemente evidenciado pela forma como a sociedade respondeu \`as imposi\c{c}\~oes sanit\'arias relativas \`a pandemia de 2020, quando os cidad\~aos tiveram que se adaptar ao isolamento e encontrar formas para continuarem produtivos por meio das redes digitais.
...
\section[Fundamenta\c{c}\~ao para o levantamento hist\'orico]{Fundamenta\c{c}\~ao para o levantamento hist\'orico}\label{Fundamenta\c{c}\~ao para o levantamento hist\'orico}
Aqui \'e o primeiro par\'agrafo de toda fundamenta\c{c}\~ao para hist\'oria
...
Para que o registro hist\'orico mencionado no primeiro item se d\^e no contexto da ci\^encia, no qual todas as afirma\c{c}\~oes deste texto devem se inserir, \'e preciso que se baseiem em um m\'etodo.
...
Ao se basearem num m\'etodo, estas afirma\c{c}\~oes de cunho hist\'orico adquirem a propriedade de serem verific\'aveis, uma vez que o caminho percorrido para sua constru\c{c}\~ao (pertinente ao m\'etodo) pode ser revisitado por outros que queiram verific\'a-las. Assim sendo, no cap\'{\i}tulo de "Materiais e M\'etodos" \'e descrito o m\'etodo utilizado para embasar o discurso hist\'orico constru\'{\i}do, deixando para o cap\'{\i}tulo de "Resultados" a apresenta\c{c}\~ao do discurso propriamente dito. Com base no m\'etodo descrito no cap\'{\i}tulo de "Materiais e M\'etodos", qualquer outro poder\'a avaliar o escopo de validade das afirma\c{c}\~oes presentes no cap\'{\i}tulo de "Resultados".
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/Herodote.jpg}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/ranke.jpg}
...
Evidente que os m\'etodos da pesquisa em Hist\'oria evolu\'{\i}ram muito depois das contribui\c{c}\~oes de Ranke e seus colegas da Escola Hist\'orica Prussiana do s\'eculo XIX.
...
\section[Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao do m\'etodo]{Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao do m\'etodo}\label{Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao do m\'etodo}
...
\section[Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao dos resultados]{Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao dos resultados}\label{Fundamenta\c{c}\~ao para a caracteriza\c{c}\~ao dos resultados}
...
\section[M\'etodo de Caracteriza\c{c}\~ao do M\'etodo do WASH]{M\'etodo de Caracteriza\c{c}\~ao do M\'etodo do WASH}\label{M\'etodo de Caracteriza\c{c}\~ao do M\'etodo do WASH}
...
\section[Narrativa do GESAC]{Narrativa do GESAC}\label{Narrativa do GESAC}
...
\section[Narrativa do OLPC]{Narrativa do OLPC}\label{Narrativa do OLPC}
...
\section[Narrativa do Afira]{Narrativa do Afira}\label{Narrativa do Afira}
...
\section[Dados da Platu\'osh]{Dados da Platu\'osh}\label{Dados da Platu\'osh}
Abaixo est\~ao presentes os gr\'aficos da platu\'osh, que \'e a plataforma do WASH.
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/distribuicao-dos-eventos-ao-longo-dos-anos-menor.png}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/distribuicao-das-idades-dos-participantes.png}

	\end{center}

	\caption{\label{distribuicao-das-idades-dos-participantes}@[caption-distribuicao-das-idades-dos-participantes]@}

	\legend{Fonte: \citeonline{cite-distribuicao-das-idades-dos-participantes}}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/participantes-por-genero.png}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/idade-mulheres-no-ano-do-evento.png}

	\end{center}

	\caption{\label{idade-mulheres-no-ano-do-evento}@[caption-idade-mulheres-no-ano-do-evento]@}

	\legend{Fonte: \citeonline{cite-idade-mulheres-no-ano-do-evento}}
...
\begin{figure}[htb]
	...
	\begin{center}
		...
		\includegraphics[scale=0.5]{../../imagens/idades-homens-no-ano-do-evento.png}

	\end{center}

	\caption{\label{idades-homens-no-ano-do-evento}@[caption-idades-homens-no-ano-do-evento]@}

	\legend{Fonte: \citeonline{cite-idades-homens-no-ano-do-evento}}

\end{figure}
\section[Dados da plataforma de planejamento]{Dados da plataforma de planejamento}\label{Dados da plataforma de planejamento}
participantes
