...
\begin{agradecimentos}
	...
	Nesta vers\~ao do Pacote USPSC, foram feitas altera\c{c}\~oes na Classe USPSC, inclus\~ao da capa exclusiva para o Faculdade de Educa\c{c}\~ao\^encias Matem\'aticas e de Computa\c{c}\~ao (ICMC), inclus\~ao de novos pacotes e altera\c{c}\~oes nos modelos de trabalhos acad\^emicos.
	...
	Na vers\~ao 3.1 houve a inclus\~ao da capa diferenciada para o Faculdade de Educa\c{c}\~ao\^encias Matem\'aticas e de Computa\c{c}\~ao (ICMC), novos cursos e programas e de algumas altera\c{c}\~oes na Classe USPSC, arquivos USPSC.cls e  USPSC1.cls.
