...
\ifthenelse{\equal{#1}{EAMB}}{
	...
	\preambulo{Monografia apresentada ao @[curso]@, da Escola de Engenharia de S\~ao Carlos da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}
...
\ifthenelse{\equal{#1}{ECOM}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da Escola de Engenharia de S\~ao Carlos e @[unidadefaculdade]@}\~ao da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
...
\ifthenelse{\equal{#1}{EELS}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da Escola de Engenharia de S\~ao Carlos da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@.}
...
\ifthenelse{\equal{#1}{EPRO}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Monografia apresentada ao @[curso]@}\~ao, da Escola de Engenharia de S\~ao Carlos da Universidade de S\~ao Paulo, como parte dos requisitos para obten\c{c}\~ao do t\'itulo de @[titulopos]@@[titulopos]@}\~ao.}
