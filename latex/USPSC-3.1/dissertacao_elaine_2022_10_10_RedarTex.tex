...
Este trabalho tem por objeto de estudo o  Projeto WASH - Workshop de Aficionados em Software e Hardware - desde sua cria\c{c}\~ao, em novembro de 2013, at\'e outubro de 2022.
...
Esta caracteriza\c{c}\~ao dar-se-\'a em 3 eixos:
...
\begin{figure}[Htb]
	...
	\begin{center}
		...
		\includegraphics[max size={\textwidth}]{../../imagens/Scratch-Block.png}

	\end{center}

	\caption{\label{5cac9c9edeb34a88b5571069bb494cda1ce1bd9c}Trecho de um c\'odigo em Scratch, em que se v\^e a organiza\c{c}\~ao por blocos, que podem ser montados como num jogo de encaixe. (Fonte: u [[SUNG (2019)]])}
