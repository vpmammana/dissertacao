\cp ../../latex/USPSC-3.1/dissertacao_final_2023_02_10.pdf ../../latex/USPSC-3.1/dissertacao_final_2023_02_10_RedarTex.pdf 
\cp ../../latex/USPSC-3.1/fichacatalografica.pdf ../../latex/USPSC-3.1/fichacatalografica_RedarTex.pdf 
...
\cp ../../latex/USPSC-3.1/USPSC-TA-PreTextual/termo-de-aprovacao-UTFPR.pdf ../../latex/USPSC-3.1/USPSC-TA-PreTextual/termo-de-aprovacao-UTFPR_RedarTex.pdf 
\cp ../../latex/USPSC-3.1/USPSC-TA-PreTextual/fichacatalografica.pdf ../../latex/USPSC-3.1/USPSC-TA-PreTextual/fichacatalografica_RedarTex.pdf 
...
\cp ../../latex/USPSC-3.1/USPSC-TA-PreTextual/fichacatalografica_UTFPR.pdf ../../latex/USPSC-3.1/USPSC-TA-PreTextual/fichacatalografica_UTFPR_RedarTex.pdf 
...
\cp ../../latex/USPSC-3.1/USPSC-classe/classe-especial-dissertacao1.cls ../../latex/USPSC-3.1/USPSC-classe/classe-especial-dissertacao1_RedarTex.cls 
\cp ../../latex/USPSC-3.1/USPSC-classe/USPSC.cls ../../latex/USPSC-3.1/USPSC-classe/USPSC_RedarTex.cls 
\cp ../../latex/USPSC-3.1/USPSC-classe/classe-especial-dissertacao.cls ../../latex/USPSC-3.1/USPSC-classe/classe-especial-dissertacao_RedarTex.cls 
...
find ../../latex/. -type f -name '*_RedarTex.cls' | xargs sed -i 's/include[{]USPSC-classe\/classe-especial-dissertacao1[}]/include{USPSC-classe\/classe-especial-dissertacao1_RedarTex}/g' 
find ../../latex/. -type f -name '*_RedarTex.cls' | xargs sed -i 's/include[{]USPSC-classe\/classe-especial-dissertacao[}]/include{USPSC-classe\/classe-especial-dissertacao_RedarTex}/g' 
...
find ../../latex/. -type f -name '*_RedarTex.tex' | xargs sed -i 's/include[{]USPSC-classe\/classe-especial-dissertacao1[}]/include{USPSC-classe\/classe-especial-dissertacao1_RedarTex}/g' 
find ../../latex/. -type f -name '*_RedarTex.tex' | xargs sed -i 's/include[{]USPSC-classe\/classe-especial-dissertacao[}]/include{USPSC-classe\/classe-especial-dissertacao_RedarTex}/g' 
...
find ../../latex/. -type f -name '*_RedarTex.cls' | xargs sed -i 's/include[{]dissertacao_elaine_2022_10_10[}]/include{dissertacao_elaine_2022_10_10_RedarTex}/g' 
