...
\ifthenelse{\equal{#1}{BQ}}{
	...
	\preambulo{Monografia apresentada ao @[unidadefaculdade]@, da @[universidade]@, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de @[titulopos]@.}
...
\ifthenelse{\equal{#1}{REQ}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição e a área de concentração 
	\preambulo{Relat\'orio de est\'agio em  Qu\'imica apresentado ao @[unidadefaculdade]@, da @[universidade]@, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de @[titulopos]@.}
