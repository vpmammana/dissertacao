...
\ifthenelse{\equal{#1}{DCEA}}{
	...
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@.}
...
\ifthenelse{\equal{#1}{MCEA}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Mestre em Ci\^encias - @[programapos]@.}
...
\ifthenelse{\equal{#1}{DEE}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@.}
	\notaficha{Dissert. (Mestrado) - @[programapos]@}
    }{
% MEE ===========================================================================
...
\ifthenelse{\equal{#1}{DEPP}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@}\~ao.}
	\notaficha{Dissert. (Mestrado) - @[programapos]@}
    }{
% MEPP ===========================================================================
\ifthenelse{\equal{#1}{MEPP}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Mestre em Ci\^encias - @[programapos]@}\~ao.}
	\notaficha{Disserta\c{c}\~ao (Mestrado) - @[programapos]@}
    }{			
% DEPE ==========================================================================
\ifthenelse{\equal{#1}{DEPE}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@}\~ao.}
	\notaficha{Dissert. (Mestrado) - @[programapos]@}\~ao em Economia, Organiza\c{c}\~oes e Gest\~ao do Conhecimento}
    }{
% MEPE ===========================================================================
...
\ifthenelse{\equal{#1}{DEMF}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@.}
	\notaficha{Dissert. (Mestrado) - @[programapos]@}\~ao em Projeto, Materiais e Manufatura}
    }{
% MEMF ===========================================================================
...
\ifthenelse{\equal{#1}{DCEM}}{
	...
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - @[programapos]@.}
	\notaficha{Dissert. (Mestrado) - @[programapos]@}\~ao em Desenvolvimento, Caracteriza\c{c}\~ao e Aplica\c{c}\~ao de Materiais}
    }{
% MCEM ===========================================================================
...
\ifthenelse{\equal{#1}{DIUB}}{
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Doutor em Ci\^encias - Programa de P\'os-Gradua\c{c}\~ao Interunidades em Bioengenharia.}
...
\ifthenelse{\equal{#1}{MIUB}}{
	...
	% O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Mestre em Ci\^encias - Programa de P\'os-Gradua\c{c}\~ao Interunidades em Bioengenharia.}
...
% Outros
    ...
    % O preambulo deve conter o tipo do trabalho, o objetivo, 
	% o nome da instituição, a área de concentração e opção quando houver
	\preambulo{Disserta\c{c}\~ao/Disserta\c{c}\~ao apresentada \`a @[unidadefaculdade]@ da Universidade de S\~ao Paulo, para obten\c{c}\~ao do t\'itulo de Mestre/Doutor em Ci\^encias - @[programapos]@.}
