...
\ifthenelse{\equal{#1}{DAUT}}{
	...
	\preambulo{Disserta\c{c}\~ao apresentada ao Programa de P\'os-Gradua\c{c}\~ao em Ensino de Ci\^encias Humanas, Sociais e da Natureza - PPGEN da Universidade Tecnol\'ogica Federal do Paran\'a, como parte dos requisitos para a obten\c{c}\~ao do t\'itulo de Ensino de Ci\^encias Humanas, Sociais e da Natureza.}
